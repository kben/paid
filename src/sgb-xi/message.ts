...
export const makePLGA = (
    ...
    isSammelrechnungPLGA: boolean
        ...
        FKT("01", absenderAndRechnungssteller(billing, invoice), invoice.faelle[0], isSammelrechnungPLGA),
        REC(billing, invoice, leistungserbringerIndex, isSammelrechnungPLGA),
        SRD(invoice.leistungserbringer, invoice.faelle[0], isSammelrechnungPLGA && billing.rechnungsart != "1"),
...
export const makePLAA = (
    ...
    leistungserbringerIndex: number,
        ...
        FKT("01", absenderAndRechnungssteller(billing, invoice), invoice.faelle[0]),
        REC(billing, invoice, leistungserbringerIndex, false),
        ...invoice.faelle.flatMap(fall => [
            INV(fall.versicherter.versichertennummer || undefined, fall.belegnummer!),
            NAD(fall.versicherter),
            MAN(fall.einsaetze[0].leistungsBeginn, fall.pflegegrad!),
...
const wrapMessage = (
    ...
    segments: any[]
        ...
        ...segments,
        UNT(segments.length + 2, messageNumber)
    ];
